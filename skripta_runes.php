<?php
  $xml = simplexml_load_file("runes.xml") or die("Error: Cannot create object");
  $odabir = (int) $_POST['select3'];
?>
...
<head>
  ...
  <title><?php echo $xml->runes[$odabir]->name;?></title>
  <style>
    * {
...
<body>
  <main>
    ...
    <?php 
      echo "<h1>". $xml->runes[$odabir]->name ."</h1>";
      echo "<img class='img1' src='". $xml->runes[$odabir]->icon ."'>";
      echo "<h3>Basic information</h3><br>";
      echo "Name: ". $xml->runes[$odabir]->name ."<br><br>";
      echo "Description: ". $xml->runes[$odabir]->longDesc ."<br><br>";
    ?>
  </main>
  <footer>
